...
class AssetDailyChecksModelHistory(models.Model):
    daily_check_history_id = models.AutoField(primary_key=True)
    ...
    modified_by = models.ForeignKey(DetailedUser, on_delete=models.PROTECT, null=True, default=None, related_name='asset_daily_check_history_modified_by')
