...
class PartsModelHistory(models.Model):
    ...
    modified_by = models.ForeignKey(DetailedUser, on_delete=models.PROTECT, null=True, default=None, related_name='parts_history_modified_by')
