...
class DeliveryCostHistory(models.Model):

    delivery_cost = models.ForeignKey(DeliveryCost, null=True, on_delete=models.SET_NULL)
    ...
    created_by = models.ForeignKey(DetailedUser, on_delete=models.PROTECT, null=True, default=None, related_name='delivery_history_cost_created_by')
    date_created = models.DateTimeField(auto_now_add=True)
    modified_by = models.ForeignKey(DetailedUser, on_delete=models.PROTECT, null=True, default=None, related_name='delivery_history_cost_modified_by')
