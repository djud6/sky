...
class DailyInspection(models.Model):
    ...
    # user actions recorded (when db is change updadte the nodified _by and the date_updated)
    created_by = models.ForeignKey(DetailedUser, on_delete=models.PROTECT, null=True, default=None, related_name='daily_inspection_created_by')
    date_created = models.DateField(auto_now_add=True)
    modified_by = models.ForeignKey(DetailedUser, on_delete=models.PROTECT, null=True, default=None, related_name='daily_inpectinon_modified_by')
