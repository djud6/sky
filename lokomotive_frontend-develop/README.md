...
```
Username: youremail@skyit.com
Password: Np1Pil7EJ1QwjIQH
```
...
Find out regression testing schedule from your collegues and use these links:

1. [Regression testing plan and tests](https://docs.google.com/spreadsheets/d/18QYaaz1GEGi6WGEAhMXqGL9ZXIfCxd2O/edit#gid=238581487)
2. [Regression testing documents (Executive/Manager)](https://docs.google.com/spreadsheets/d/1SeKShVgdCDnVI5XnjL-6Aena_2Dkr0R40gLGpazs5ho/edit#gid=1414018887)
3. [Regression testing documents (Operator)](https://docs.google.com/spreadsheets/d/1IXmHm_KbyQcDSEdUADHKvCPukK_8614fpu-7q56_dY8/edit#gid=2125580819)
4. [Regression Trello board](https://trello.com/b/yRlMcUT0/regression-testing)

_Make sure you have access to shared resourses!_
...
1. [Design Guidelines](https://xd.adobe.com/view/711f7681-a383-40f8-8530-10891d12389c-244c/)
2. [(Manager/Executive) Desktop view](https://xd.adobe.com/view/8562492c-d230-4a62-a0b7-e047eb0d78e0-d031/)
3. [(Manager/Executive) Mobile view](https://xd.adobe.com/view/a89c6495-e012-4480-a5ac-21c38a421c61-fdcf/)
4. [(Operator) Desktop view](https://xd.adobe.com/view/a7ff9628-0ac0-4e8a-98dc-29d08cb3a54f-f2ac/)
5. [(Operator) Mobile view](https://xd.adobe.com/view/0fc7fcb3-c395-41fe-a7d9-db8d244a0d27-5a94/)

# Knowledge base

To understand how all the features of the app work, use [Knowledge Base](https://docs.google.com/document/d/1DBKpqNSDk2CA100QviE-RaYKnSMsK5PdrjjeuA5VPR8/)
_Make sure you have access_
